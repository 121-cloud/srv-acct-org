 ...
 */
public class AccountQueryHandler extends OtoCloudEventHandlerImpl<JsonObject> {

	private static final String ADDRESS = "query";
	
    public AccountQueryHandler(OtoCloudComponentImpl componentImpl) {
        super(componentImpl);
    }
    ...
    public void handle(CommandMessage<JsonObject> msg) {
        ...
        AccountDAO accountDAO = new AccountDAO(this.componentImpl.getSysDatasource());
        accountDAO.getAccountListByPage(pagingOptions, pageFuture);
        ...
        pageFuture.setHandler(ret -> {
            ...
            accountDAO.countAccount(countFuture);
